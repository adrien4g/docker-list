        ...
        for container in container_list:
            ...
            if self.check_for_docker_compose(selected_container):
                ...
                for vol in selected_container["Mounts"]:
                    ...
                    self.container_data.volume_size.append(utils.calculate_files_size(vol["Source"]))
